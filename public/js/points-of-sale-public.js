	...
	jQuery(document).ready(function($) {
		...
		pos_dropdown_states.on('change', function() {
			...
			.done(function( response ) {
				...
				if( response.cities.length != pos_dropdown_cities.length ){
				    ...
				    pos_dropdown_cities.prepend( $("<option />").attr('selected', 'selected').val( null ).text( 'Selecione a cidade:' ) );
		...
		pos_dropdown_cities.on('change', function() {
			...
			.done(function( response ) {
			    ...
			    pos_dropdown_neighborhoods.prepend( $("<option />").attr('selected', 'selected').val( null ).text( 'Selecione o bairro:' ) );
